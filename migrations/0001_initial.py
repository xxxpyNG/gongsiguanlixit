    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.DecimalField(decimal_places=2, default=0, max_digits=10, verbose_name='工资收入')),
                ('creat_time', models.DateTimeField(verbose_name='入职时间')),
                ('gender', models.SmallIntegerField(choices=[(1, '男'), (2, '女')], verbose_name='用小整形表示性别')),
